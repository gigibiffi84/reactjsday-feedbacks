    ...
    <div className="space-y-8">
      <div className="space-y-4">
        <h2 className="text-4xl font-bold text-balance">
          Prevent Form Freeze with useTransition
        </h2>
        <p className="text-lg text-muted-foreground">
          Keep your UI responsive during expensive state updates
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            When you update state that triggers expensive computations, the UI
            can freeze and feel unresponsive.
          </p>
    ...
    setResults(
      expensiveFilter(value)
          ...
          <div className="bg-accent/50 p-4 rounded-lg border border-border mt-4">
            <p className="text-sm">
              <strong>Key benefit:</strong> The input stays responsive while the
      ...
      <div className="bg-accent/50 p-6 rounded-lg border border-border">
        ...
        <p className="text-sm text-muted-foreground">
          Use useTransition and startTransition to mark state updates as
          non-urgent. This keeps your forms and inputs responsive even during
          expensive operations like filtering large lists or complex
          calculations.
        </p>
      </div>
    </div>
